        ...
        {step === 1 && (
          <div className="space-y-3">
            <div>
              ...
              <input className="input-base" placeholder="Ex: Promoção Marco 2026" value={name} onChange={(e) => setName(e.target.value)} />
            </div>
            <div>
        ...
        {step === 2 && (
          <div className="space-y-3">
            ...
            <textarea className="input-base" rows={6}
              placeholder="Ola {{nome}}, temos uma promoção especial para si!"
